...
<template>
  <div class="relative w-full py-16 overflow-hidden bg-gradient-to-b from-gray-50/50 to-transparent dark:from-gray-900/30 dark:to-transparent">
    <UContainer>
      ...
      <div class="relative max-w-5xl mx-auto min-h-[550px]">
        <!-- Bulle utilisateur en haut -->
        <Transition name="bubble">
          <div
            v-if="showUserMessage"
            class="absolute top-0 left-0 md:left-12 max-w-md z-20"
          >
        ...
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
          ...
          >
            ...
            <!-- Logo BotItYourself -->
            <div class="relative bg-white dark:bg-gray-900 rounded-xl p-5 shadow-2xl border-2 border-primary-500/50">
              <img
        ...
        <div class="absolute top-1/2 -translate-y-1/2 right-0 md:right-12 flex flex-col gap-6">
          <!-- Stripe -->
        ...
        <Transition name="bubble">
          <div
            ...
            class="absolute -bottom-8 right-0 md:right-12 max-w-md z-20"
          >
